...
#second plot - Voltage Vs date_time
        with(plot1_data, base::plot(date_time, voltage, type = "l", ylab = "Voltage (V)", xlab = "datetime"  ))
...
#fourth plot - reactive power vs date_time
        with(plot1_data, base::plot(date_time, power_reactive_global, type = "l", ylab = "Global_reactive_power (kW)", xlab = "datetime"  ))
