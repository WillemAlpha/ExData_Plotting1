...
#convert date column to date
        ...
        #alternatively:
        #plot1_data[[1]] <- strptime(plot1_data[[1]], format = "%d/%m/%Y")
...
hist(plot1_data$power_active_global, main = "Global Active Power", xlab = "Global Active Power (kW)", ylab = "Frequency", col = "red" )
dev.off()
